...
function Project({ title, image, description, techstack, previewLink, githubLink }) {
  return (
    <article className="rounded-xl mt-10 overflow-hidden bg-gray-100 dark:bg-gray-900">
      ...
      <div className="p-4 text-gray-900 dark:text-gray-100">
        ...
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            <svg
              className="stroke-gray-900 dark:stroke-gray-100 inline-block min-w-fit"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
            ...
            <a
              ...
              className="underline pl-2 font-medium hover:text-blue-600 dark:hover:text-blue-400"
            >
              Live Preview
            </a>
          </div>
          <div className="flex items-center">
            <svg
              className="fill-gray-900 dark:fill-gray-100 inline-block min-w-fit"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
